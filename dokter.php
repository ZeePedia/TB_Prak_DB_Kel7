<?php
    ...
    $query = "SELECT dokter.*, spesialis.spesialis FROM dokter
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      ...
      <div class="container">
        ...
        <figure>
            ...
            <p> Besisi Data Dokter Puskesmas</p>
            </blockquote>
        ...
        <a href="kelola_d.php" type="button" class="btn btn-primary mb-3">
            ...
            <table class="table align-middle table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <center>
                            <a href="kelola_d.php?ubah=<?php echo $result['id_dokter']; ?>" type="button" class="btn btn-success btn-sm">
                                <i class="fa fa-pencil"></i>
                            </a>
                            <a href="p_dokter.php?hapus=<?php echo $result['id_dokter']; ?>" type="button" class="btn btn-danger btn-sm" onClick="return confirm('Anda yakin ingin menghapus data???')">
